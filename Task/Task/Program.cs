                ...
                switch (key)
                {
                    ...
                    case 1:
                        ...
                        do
                        {
                            ...
                            if (workingHour < 0 || workingHour > 250)
                            {
                                Console.WriteLine("Aylıq iş saatı 250 saatdan çox ola bilməz");
                            }
                        } while (workingHour < 0 || workingHour > 250);
                        Employee e = new Employee(name, surname, age, salaryOfHour, workingHour);
                        Console.WriteLine($"Ayliq maas: {salaryOfHour * workingHour}");
                        break;
                    case 2:
                        Console.WriteLine("Ad daxil edin: ");
                        name = Convert.ToString(Console.ReadLine());
                        ...
                        Console.WriteLine($"İmtahan nəticəsi: {languageRank + iqRank}");
                        break;
                    case 3:
